...
golem::fill_desc(
  pkg_name = "vetapp", # The Name of the package containing the App 
  pkg_title = "vetapp", # The Title of the package containing the App 
  pkg_description = "Veterinary Clinic management tool", # The Description of the package containing the App 
